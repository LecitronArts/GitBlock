...
public final class GitBlockMenuModel {
    ...
    static final int SUBMENU_SIZE = 54;
    static final int COMMIT_CONFIRM_SIZE = 27;

    static final int SLOT_REPOS = 19;
    ...
    static final int SLOT_COMMIT_MESSAGE = 26;
    ...
    static final int SLOT_CONFIRM_INFO = 13;
    static final int SLOT_CONFIRM_CLOSE = 22;
    ...
    static final Map<Integer, String> ACTION_SLOT_TO_KEY =
            Map.ofEntries(
                    Map.entry(SLOT_REPOS, "repos"),
                    Map.entry(SLOT_STATUS, "status"),
                    Map.entry(SLOT_LOG, "log"),
                    Map.entry(SLOT_BRANCHES, "branches"),
                    Map.entry(SLOT_COMMIT, "commit"),
                    Map.entry(SLOT_JOBS, "jobs"),
                    Map.entry(SLOT_CHECKPOINT, "checkpoint"),
                    Map.entry(SLOT_COMMIT_MESSAGE, "commit_message"),
                    Map.entry(SLOT_CHECKOUT_HELP, "checkout_help"),
                    Map.entry(SLOT_DIFF_HELP, "diff_help"),
                    Map.entry(SLOT_CLOSE, "close"));
    ...
    static int[] selectorSlots() {
        return SELECTOR_SLOTS.clone();
    }
}
